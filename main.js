var bn1, bn2, en1, en2, mth, bgs, sci, isl, ict, agri, numShower;
...
function count(){
var totalMark =Number(bn1.value) + Number(bn2.value) + Number(en1.value) + Number(en2.value) + Number(mth.value) + Number(bgs.value) + Number(sci.value) + Number(ict.value) + Number(agri.value);
